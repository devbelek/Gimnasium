...
class Comment(models.Model):
    our_achievements = models.ForeignKey(
        ...
        null=True, blank=True, verbose_name='Связка с "Наши достижения"', related_name='comment_our_achievements'
    )
    news = models.ForeignKey(
        'main.News', on_delete=models.CASCADE,
        null=True, blank=True, verbose_name='Связка с "Новости"', related_name='comment_news'
    )
    successful_graduates = models.ForeignKey(
        'main.SuccessfulGraduates', on_delete=models.CASCADE,
        null=True, blank=True, verbose_name='Связка с "Успешные студенты"', related_name='comment_successful_graduates'
    )
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Автор', related_name='comment_authors')
...
class CommentReply(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Автор', related_name='comment_reply_authors')
...
class Like(models.Model):
    comment = models.ForeignKey(Comment, related_name='comment_likes', on_delete=models.CASCADE, verbose_name='Комментарий')
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Пользователь', related_name='user_likes')
